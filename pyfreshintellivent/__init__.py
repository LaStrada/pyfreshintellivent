...
DEFAULT_MAX_UPDATE_ATTEMPTS = 3  # Number of retry attempts
...
class FreshIntelliventDevice:
    ...
    model: str = "Intellivent Sky"
    hw_version: str | None = None
    sw_version: str | None = None
    fw_version: str | None = None
    sensors: dict[str, float | int | str | None] = dataclasses.field(default_factory=dict)
...
class FreshIntelliventBluetoothDeviceData:
    ...
    async def _get_device_info(
        ...
        try:
            ...
            device.name = name_bytes.decode("utf-8").replace("\00", "").replace("\0", "")
        except BleakError:
